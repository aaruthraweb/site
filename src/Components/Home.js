...
import imgdec from '../css/Decorplast.png';
import logo from '../Asserts/about.png';
...
const Home = () => {
  ...
  return (
    ...
    {showMediaIcons && (
      ...
      <div className="container-abt">
        ...
        <div className="hometagline">
          <h3>~Where Imagination Meets Interiors</h3>
        </div>
    ...
    >
      ...
      <img src={imgdec} className='decorplastlogo' />
      </div>
        <h6 className="hom-fixed-grid-container" style={{marginTop:'26px'}}>We are proud to be your trusted Decorplast dealer in Tamil Nadu, offering a wide range of
         high-quality decor solutions. Whether you're looking to enhance your home or office, we provide stylish,
          durable products to meet all your needs. 
        Transform your space with the best—choose Decorplast for unmatched elegance and reliability!</h6>
